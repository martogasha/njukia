                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6 pb-2 pb-sm-0">
                            <div class="widget">
                                ...
                                <a href="demo1.html">
                                    <img src="{{asset('asseti/images/logo-footer.png')}}" alt="Logo" class="logo-footer">
                                </a>
                        ...
                        <div class="col-lg-3 col-sm-6 pb-4 pb-sm-0">
                            <div class="widget mb-2">
                                ...
                                <ul class="contact-info m-b-4">
                                    ...
                                    <li>
                                        <span class="contact-info-label">Email:</span> <a href="https://portotheme.com/cdn-cgi/l/email-protection#b8d5d9d1d4f8ddc0d9d5c8d4dd96dbd7d5"><span class="__cf_email__" data-cfemail="9ff2fef6f3dffae7fef2eff3fab1fcf0f2">[email&#160;protected]</span></a>
                                    </li>
                                    <li>
                ...
                <div class="footer-bottom d-sm-flex align-items-center">
                    ...
                    <div class="footer-right ml-auto mt-1 mt-sm-0">
                        <div class="payment-icons">
                            <span class="payment-icon visa" style="background-image: url({{asset('asseti/images/payments/payment-visa.svg')}})"></span>
                            <span class="payment-icon visa" style="background-image: url({{asset('asseti/images/payments/payment-paypal.svg')}})"></span>
                            <span class="payment-icon stripe" style="background-image: url({{asset('asseti/images/payments/payment-stripe.png')}})"></span>
                            <span class="payment-icon verisign" style="background-image:  url({{asset('asseti/images/payments/payment-verisign.svg')}})"></span>
                        </div>
                    </div>
                </div>
            </div>
